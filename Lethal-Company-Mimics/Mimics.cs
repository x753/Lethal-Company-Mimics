...
namespace Mimics
{
    ...
    public class Mimics : BaseUnityPlugin
    {
        ...
        internal class StartOfRoundPatch
        {
            ...
            static void StartPatch(ref StartOfRound __instance)
            {
                ...
                if (__instance.IsServer && MimicNetworker.Instance == null)
                {
                    ...
                    mimicNetworker.GetComponent<NetworkObject>().Spawn();
                }
            }
        }
        ...
        internal class RoundManagerPatch
        {
            ...
            static void SetExitIDsPatch(ref RoundManager __instance, Vector3 mainEntrancePosition)
            {
                ...
                int numMimics = 0;
                {
                    int[] spawnRates = new int[] { MimicNetworker.Instance.SpawnWeight0.Value, MimicNetworker.Instance.SpawnWeight1.Value, MimicNetworker.Instance.SpawnWeight2.Value, MimicNetworker.Instance.SpawnWeight3.Value, MimicNetworker.Instance.SpawnWeight4.Value, MimicNetworker.Instance.SpawnWeightMax.Value };
                    ...
                    if (MimicNetworker.Instance.SpawnRateDynamic.Value && numMimics < fireExitCount && fireExitCount > 1)
                    {
                    ...
                    if (MimicNetworker.Instance.SpawnRateDynamic.Value && dungeon.AllTiles.Count > 100)
                    {
        ...
        internal class SprayPaintItemPatch
        {
            ...
            static void SprayPaintClientRpcPatch(SprayPaintItem __instance, Vector3 sprayPos, Vector3 sprayRot)
            {
                ...
                RaycastHit raycastHit = __instance.sprayHit;
        ...
        internal class LockPickerPatch
        {
            ...
            static void ItemActivatePatch(LockPicker __instance, bool used, bool buttonDown = true)
            {
                ...
                RaycastHit raycastHit = __instance.hit;
    ...
    public class MimicNetworker : NetworkBehaviour
    {
        ...
        public NetworkVariable<int> SpawnWeight0 = new NetworkVariable<int>();
        public NetworkVariable<int> SpawnWeight1 = new NetworkVariable<int>();
        public NetworkVariable<int> SpawnWeight2 = new NetworkVariable<int>();
        public NetworkVariable<int> SpawnWeight3 = new NetworkVariable<int>();
        public NetworkVariable<int> SpawnWeight4 = new NetworkVariable<int>();
        public NetworkVariable<int> SpawnWeightMax = new NetworkVariable<int>();
        public NetworkVariable<bool> SpawnRateDynamic = new NetworkVariable<bool>();

        public override void OnNetworkSpawn()
        {
            MimicNetworker.Instance = this;

            if (IsServer)
            {
                MimicNetworker.Instance.SpawnWeight0.Value = Mimics.SpawnRates[0];
                MimicNetworker.Instance.SpawnWeight1.Value = Mimics.SpawnRates[1];
                MimicNetworker.Instance.SpawnWeight2.Value = Mimics.SpawnRates[2];
                MimicNetworker.Instance.SpawnWeight3.Value = Mimics.SpawnRates[3];
                MimicNetworker.Instance.SpawnWeight4.Value = Mimics.SpawnRates[4];
                MimicNetworker.Instance.SpawnWeightMax.Value = Mimics.SpawnRates[5];
                MimicNetworker.Instance.SpawnRateDynamic.Value = Mimics.DynamicSpawnRate;
            }
        }
